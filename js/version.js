(function () {
  window.OSM_APP_VERSION = {
    ...
    version: "2026.07.23-seo-batch-completions.17",
    releaseDate: "2026-07-23",
    appUrl: "https://oncc-erp.pages.dev",
    deployment: "Cloudflare Pages",
    installMode: "Windows Cloud-App",
    updateMode: "Automatisch Ã¼ber Cloudflare",
    databaseTarget: "Cloudflare D1",
    fileStorageTarget: "Cloudflare R2 oder Google Drive fÃ¼r Dokumente",
